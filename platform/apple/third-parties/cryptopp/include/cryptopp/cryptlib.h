...
public:
	...
	enum ErrorType {
		...
		OTHER_ERROR,
        //! exception thrown trying to parse an invalid certificate
        INVALID_CERTIFICATE
	};
...
//! exception thrown trying to parse an invalid certificate
class CRYPTOPP_DLL X509CertificateError : public Exception
{
public:
	explicit X509CertificateError(const std::string &s) : Exception(INVALID_CERTIFICATE, s) {}
};
