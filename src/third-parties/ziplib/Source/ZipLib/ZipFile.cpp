...
{
  AddEncryptedFile(zipPath, dataStream, inArchiveName, std::string(), method);
}
...
void ZipFile::AddEncryptedFile(const std::string& zipPath, const std::string& fileName, const std::string& inArchiveName, const std::string& password, ICompressionMethod::Ptr method)
{
    ...
    AddEncryptedFile(zipPath, fileToAdd, inArchiveName, password, method);
}

void ZipFile::AddEncryptedFile(const std::string& zipPath, std::istream& dataStream, const std::string& inArchiveName, const std::string& password, ICompressionMethod::Ptr method)
{
...

    {
        ...
        fileEntry->SetCompressionStream(dataStream, method);
